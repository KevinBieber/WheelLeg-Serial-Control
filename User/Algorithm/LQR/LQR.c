...
void LQRCalculate(float leg_length,uint8_t leg_side){//leg_side:0-left leg,1-right leg
    ...
    K_data[0] = -1.2152f * L_3 + 5.6587f * L_2 + -2.0705f * L_1 + 3.6191f;
    K_data[1] = -0.1409f * L_3 + 1.9166f * L_2 + -0.2697f * L_1 + 0.7642f;
    K_data[2] = 0.1648f * L_3 + -0.7359f * L_2 + 1.1233f * L_1 + 0.3836f;
    K_data[3] = 0.5098f * L_3 + -2.0674f * L_2 + 3.1236f * L_1 + 0.5566f;
    K_data[4] = 1.2774f * L_3 + -2.6755f * L_2 + -4.6717f * L_1 + 12.9793f;
    K_data[5] = 0.0617f * L_3 + -0.0571f * L_2 + -0.5325f * L_1 + 1.5821f;
    K_data[6] = 3.3781f * L_3 + -20.5734f * L_2 + 41.7678f * L_1 + -45.6411f;
    K_data[7] = -0.4175f * L_3 + 0.2510f * L_2 + 1.7101f * L_1 + -9.6199f;
    K_data[8] = 0.3125f * L_3 + -2.5879f * L_2 + 7.6388f * L_1 + -8.6095f;
    K_data[9] = -0.6761f * L_3 + 0.2446f * L_2 + 8.0646f * L_1 + -14.8759f;
    K_data[10] = 13.1726f * L_3 + -68.1842f * L_2 + 126.9402f * L_1 + 37.8255f;
    K_data[11] = 1.0660f * L_3 + -5.5060f * L_2 + 10.8483f * L_1 + 1.1334f;
